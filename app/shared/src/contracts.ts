...
export const matchOverviewSchema = z.object({
  ...
  radiantTeamId: z.number().nullable().default(null),
  radiantTeamName: z.string().nullable().default(null),
  radiantTeamTag: z.string().nullable().default(null),
  direTeamId: z.number().nullable().default(null),
  direTeamName: z.string().nullable().default(null),
  direTeamTag: z.string().nullable().default(null),
...
export const settingsSchema = z.object({
  ...
  openDotaPerSecondCap: z.number().int().min(1).max(1000).default(5),
  openDotaPerMinuteCap: z.number().int().min(1).max(10000).default(60),
  openDotaPerHourCap: z.number().int().min(1).max(100000).default(1000),
  openDotaDailyRequestCap: z.number().int().min(1).max(100000).default(5000),
  steamPerSecondCap: z.number().int().min(1).max(1000).default(2),
  steamPerMinuteCap: z.number().int().min(1).max(10000).default(60),
  steamPerHourCap: z.number().int().min(1).max(100000).default(1000),
  steamDailyRequestCap: z.number().int().min(1).max(100000).default(5000),
  providerEnrichmentDailyRequestCap: z.number().int().min(1).max(100000).default(1000),
  providerEnrichmentMaxAttempts: z.number().int().min(1).max(20).default(3),
  providerEnrichmentWorkerEnabled: z.boolean().default(false),
  providerEnrichmentWorkerIntervalMinutes: z.number().int().min(1).max(1440).default(30),
  providerEnrichmentWorkerScanLimit: z.number().int().min(1).max(1000).default(200),
  providerEnrichmentWorkerJobsPerRun: z.number().int().min(1).max(25).default(5),
